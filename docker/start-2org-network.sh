...
docker-compose -f docker-compose.yml up -d \
    ca.org1.netbuild.hu ca.org2.netbuild.hu\
    orderer.netbuild.hu orderer2.netbuild.hu orderer3.netbuild.hu \
    couchdbOrg1Peer0 couchdbOrg1Peer1 \
    peer0.org1.netbuild.hu peer1.org1.netbuild.hu \
    couchdbOrg2Peer0 couchdbOrg2Peer1 \
    peer0.org2.netbuild.hu peer1.org2.netbuild.hu \
    cli
