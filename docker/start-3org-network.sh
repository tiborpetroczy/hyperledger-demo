...
# Set env vars
export CHANNEL=demochannel

docker-compose -f docker-compose.yml down

docker-compose -f docker-compose.yml up -d \
    ca.org1.netbuild.hu ca.org2.netbuild.hu ca.org3.netbuild.hu \
    orderer.netbuild.hu orderer2.netbuild.hu orderer3.netbuild.hu \
    couchdbOrg1Peer0 couchdbOrg1Peer1 peer0.org1.netbuild.hu peer1.org1.netbuild.hu \
    couchdbOrg2Peer0 couchdbOrg2Peer1 peer0.org2.netbuild.hu peer1.org2.netbuild.hu \
    couchdbOrg3Peer0 couchdbOrg3Peer1 peer0.org3.netbuild.hu peer1.org3.netbuild.hu \
    cli prometheus grafana fluentd \
    explorerdb explorer
...
docker exec cli peer channel create -o orderer.netbuild.hu:7050 -c $CHANNEL -f /etc/hyperledger/configtx/$CHANNEL.tx --tls --cafile $ORDERER_TLS_CA
...
docker exec -e CORE_PEER_LOCALMSPID=Org2MSP -e CORE_PEER_ADDRESS=peer0.org2.netbuild.hu:7051 \
    ...
    cli peer channel fetch oldest $CHANNEL.block -c $CHANNEL --orderer orderer.netbuild.hu:7050 --tls --cafile $ORDERER_TLS_CA
...
docker exec -e CORE_PEER_ADDRESS=peer1.org1.netbuild.hu:7051 \
    ...
    cli peer channel update -o orderer.netbuild.hu:7050 --tls --cafile $ORDERER_TLS_CA -c $CHANNEL -f /etc/hyperledger/configtx/Org1MSPanchors.tx 
...
docker exec -e CORE_PEER_LOCALMSPID=Org2MSP -e CORE_PEER_ADDRESS=peer1.org2.netbuild.hu:7051 \
    ...
    -e CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org2.netbuild.hu/peers/peer1.org2.netbuild.hu/tls/ca.crt \
    -e CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org2.netbuild.hu/users/Admin@org2.netbuild.hu/msp \
    cli peer channel update -o orderer.netbuild.hu:7050 --tls --cafile $ORDERER_TLS_CA -c $CHANNEL -f /etc/hyperledger/configtx/Org2MSPanchors.tx 
...
docker exec -e CORE_PEER_LOCALMSPID=Org3MSP -e CORE_PEER_ADDRESS=peer1.org3.netbuild.hu:7051 \
    ...
    -e CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org3.netbuild.hu/peers/peer1.org3.netbuild.hu/tls/ca.crt \
    -e CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org3.netbuild.hu/users/Admin@org3.netbuild.hu/msp \
    cli peer channel update -o orderer.netbuild.hu:7050 --tls --cafile $ORDERER_TLS_CA -c $CHANNEL -f /etc/hyperledger/configtx/Org3MSPanchors.tx 
